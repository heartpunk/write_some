...
(function() {
  var set_saved, set_saving, watch_form;

  watch_form = function() {
    var body_was, form, input, save_indicator;
    ...
    if (input.val() !== input.attr('data')) {
      ...
      return $.ajax(form.action + '.json', {
        type: 'PUT',
        data: $(form).serialize(),
        success: function() {
          return set_saved(save_indicator, body_was);
        }
      });
    }
  };

  set_saving = function(save_indicator) {
    return save_indicator.removeClass('label-success').addClass('label-info').text('saving...');
  };

  set_saved = function(save_indicator) {
    return save_indicator.removeClass('label-info').addClass('label-success').text('saved.');
  };
